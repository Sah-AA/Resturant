...
function DropdownMenuPortal({
  ...
  return (
    React.createElement(DropdownMenuPrimitive.Portal, { 'data-slot': "dropdown-menu-portal", ...props} )
  )
}
...
function DropdownMenuTrigger({
  ...
  return (
    React.createElement(DropdownMenuPrimitive.Trigger, {
...
function DropdownMenuGroup({
  ...
  return (
    React.createElement(DropdownMenuPrimitive.Group, { 'data-slot': "dropdown-menu-group", ...props} )
  )
}
...
function DropdownMenuRadioGroup({
  ...
  return (
    React.createElement(DropdownMenuPrimitive.RadioGroup, {
...
function DropdownMenuSub({
  ...
  return React.createElement(DropdownMenuPrimitive.Sub, { 'data-slot': "dropdown-menu-sub", ...props} )
}
