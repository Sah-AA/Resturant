...
function Select({
  ...
  return React.createElement(SelectPrimitive.Root, { 'data-slot': "select", ...props} )
}

function SelectGroup({
  ...props
}) {
  return React.createElement(SelectPrimitive.Group, { 'data-slot': "select-group", ...props} )
}

function SelectValue({
  ...props
}) {
  return React.createElement(SelectPrimitive.Value, { 'data-slot': "select-value", ...props} )
}
