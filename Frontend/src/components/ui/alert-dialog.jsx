...
function AlertDialogTrigger({
  ...
  return (
    React.createElement(AlertDialogPrimitive.Trigger, { 'data-slot': "alert-dialog-trigger", ...props} )
  )
}
...
function AlertDialogPortal({
  ...
  return (
    React.createElement(AlertDialogPrimitive.Portal, { 'data-slot': "alert-dialog-portal", ...props} )
  )
}
...
function AlertDialogContent({
  ...
  return (
    React.createElement(AlertDialogPortal, {}
...
function AlertDialogAction({
  ...
  return (
    React.createElement(Button, { variant: variant, size: size, asChild: true}
